      ...
      >
                ...
                <div className="flex-1 flex flex-col justify-between">
                  <div>
                    <div className="flex justify-between items-start">
                        ...
                        <span className="text-sm font-light text-[#2C2A26]">{item.price.toLocaleString()} DA</span>
                    </div>
        ...
        <div className="p-6 border-t border-[#D6D1C7] bg-[#EBE7DE]/30">
          <div className="flex justify-between items-center mb-6">
            ...
            <span className="text-xl font-serif text-[#2C2A26]">{total.toLocaleString()} DA</span>
          </div>
