...
import { BRAND_NAME, SUB_BRAND } from '../constants';
      ...
      >
        <div className="max-w-[1800px] mx-auto px-8 flex items-center justify-between">
          ...
          <a 
            ...
            className="flex flex-col items-start z-50 relative group select-none cursor-pointer"
          >
            <span className={`text-3xl font-serif font-medium tracking-wide transition-all duration-700 ease-in-out group-hover:tracking-widest ${textColorClass}`}>
              {BRAND_NAME}
            </span>
            <span className={`text-[9px] font-sans font-medium tracking-[0.25em] uppercase opacity-60 mt-0.5 transition-colors duration-500 ${textColorClass}`}>
              {SUB_BRAND}
            </span>
          </a>
