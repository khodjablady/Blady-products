...
const Assistant: React.FC = () => {
  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    { role: 'model', text: 'Marhaban bikoum to Blady Terroir. I am your concierge, here to help you explore Algeria\'s finest cold-pressed oils, sun-dried figs, and expert agronomist services. How can I guide you today?', timestamp: Date.now() }
  ]);
