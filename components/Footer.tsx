    ...
    <footer className="bg-[#EBE7DE] pt-24 pb-12 px-6 text-[#5D5A53]">
      <div className="max-w-[1800px] mx-auto grid grid-cols-1 md:grid-cols-12 gap-12">
        ...
        <div className="md:col-span-4">
          <h4 className="text-2xl font-serif text-[#2C2A26] mb-6">Blady Terroir</h4>
          <p className="max-w-xs font-light leading-relaxed">
            Nurturing Algeria's premium organic heritage. Born from the sun, built for the soul. Extra-virgin oils and ancestral dried fruits.
          </p>
        </div>
        ...
        <div className="md:col-span-2">
          ...
          <ul className="space-y-4 font-light">
            ...
            <li><a href="#products" onClick={(e) => onLinkClick(e, 'products')} className="hover:text-[#2C2A26] transition-colors underline-offset-4 hover:underline">Olive Oils</a></li>
            <li><a href="#products" onClick={(e) => onLinkClick(e, 'products')} className="hover:text-[#2C2A26] transition-colors underline-offset-4 hover:underline">Dried Figs</a></li>
            <li><a href="#products" onClick={(e) => onLinkClick(e, 'products')} className="hover:text-[#2C2A26] transition-colors underline-offset-4 hover:underline">Agri Services</a></li>
          </ul>
        </div>
